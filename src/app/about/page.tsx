...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "arnav.offsec@gmail",
    href: "mailto:arnav.offsec@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/none",
    content: "/none",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/corpse-x",
    content: "/corpse-x",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Arnav, a Fullstack developer passionate about
